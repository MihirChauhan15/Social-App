...
SocialApp allows users to post text messsages and view others users's post. Users can also react to other user's post.It also has google sign in authentication. MVVM architecture and FirebaseFireStore was used to build this app. 
